            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $tampil['isi_berita']; ?>
                  </td>
                  <td><?php echo $tampil['kategori']; ?></td>
                  <td><a class="btn btn-warning" href="editberita.php?id=<?php echo $tampil['id_berita'] ?>"> Edit</a>&nbsp;&nbsp;&nbsp;<a class="btn btn-danger" href="hapusberita.php?id=<?php echo $tampil['id_berita'] ?>"> Hapus</a></td>
